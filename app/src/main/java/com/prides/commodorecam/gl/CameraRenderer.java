package com.prides.commodorecam.gl;
...
public class CameraRenderer extends GLSurfaceView implements 
	...
	public synchronized void onSurfaceCreated(GL10 gl, EGLConfig config) {
		try {
			mOffscreenShader.setProgram(R.raw.vshader, R.raw.fpixelshader, mContext);
		} catch (Exception e) {
	...
	public synchronized void onSurfaceChanged(GL10 gl, int width, int height) {
		...
		Log.d("CameraRenderer", "Cameras number: " + Camera.getNumberOfCameras());
